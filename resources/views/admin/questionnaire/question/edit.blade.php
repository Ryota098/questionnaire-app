...
<main class="sm:max-w-3xl sm:mx-auto mt-10 pb-20 px-2 sm:px-6">
    <div class="w-full">
        ...
        <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-sm sm:shadow-md">
            ...
            <form action="{{ route('questionnaire.question.update', $questionnaire) }}" method="POST" class="w-full p-6">
                @csrf
                ...
                <div class="flex flex-col gap-2 font-bold my-6">
                    ...
                    <input type="text" name="question[question]" value="{{ $question->question }}" placeholder="例）会社について生徒に伝えることができたと思いますか？"
                ...
                <div>
                    <fieldset>
                        <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[0]->answer }}"
                        ...
                        <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[1]->answer }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                        ...
                        <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[2]->answer }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                        ...
                        <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[3]->answer }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                        ...
                        <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[4]->answer }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                         ...
                         <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[5]->answer }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                         ...
                         <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[6]->answer }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                        ...
                        <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[7]->answer }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                        ...
                        <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[8]->answer }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                        ...
                        <div class="flex flex-col gap-2 font-bold mb-6">
                            ...
                            <input type="text" name="answers[][answer]" value="{{ $question->answers[9]->answer }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                    </fieldset>
